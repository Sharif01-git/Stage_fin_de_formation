					...
					<div class="d-flex flex-row-fluid flex-column justify-content-between">
						...
						<div class="d-flex flex-column-fluid flex-column flex-center mt-5 mt-lg-0">
							...
							<div class="login-form login-signin">
								...
								<!--begin::Form-->
								<form class="form" action="/connexionA" method="POST" novalidate="novalidate" id="kt_login_signin_form">
                                    @csrf
							...
							<div class="login-form login-signup">
								...
								<form class="form" method="POST" action="{{ route('register') }}" novalidate="novalidate" id="">
                                    @csrf
									<div class="form-group py-3 m-0">
										<input id="name" type="text" class="form-control placeholder-dark-75 @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="Nom"/>
									</div>
                                    @error('name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                    ...
                                    @enderror
									<div class="form-group py-3 border-top m-0">
										<input class="form-control placeholder-dark-75" name="prenom" type="text" value="" autofocus placeholder="Prénom" />
									</div>
									<div class="form-group py-3 border-top m-0">
										<input type="text" class="form-control placeholder-dark-75" name="telephone" value="" placeholder="Phone" placeholder="Téléphone"/>
									</div>
                                    <div class="form-group py-3 border-top m-0">
										<input class="form-control placeholder-dark-75" name="adresse" type="text" value=""  placeholder="Adresse"/>
									</div>
                                    <div class="form-group py-3 border-top m-0">
                                    ...
                                    <div class="form-group py-3 border-top m-0">
										<input id="email" type="email" class="form-control placeholder-dark-75 @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="Email"/>
									</div>
                                    @error('email')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                    ...
                                    @enderror
                                    <div class="form-group py-3 border-top m-0">
										<input id="password" type="password" class="form-control placeholder-dark-75 @error('password') is-invalid @enderror" name="password" required autocomplete="new-password" placeholder="Mot de passe"/>
									</div>
                                    @error('password')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
							...
							<div class="login-form login-forgot">
								<div class="text-center mb-10 mb-lg-20">
									...
									<p class="text-muted font-weight-bold">Entre votre email pour rénitialiser votre mot de passe.</p>
								</div>
								<!--begin::Form-->
