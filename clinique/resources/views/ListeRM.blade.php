                        ...
                        <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $rendezvou->nomd}}</td>
                                    <td>{{ $rendezvou->prenomd}}</td>
                                    <td>{{ $rendezvou->aged}}</td>
                                    <td>{{ $rendezvou->contact}}</td>
                                    <td>{{ $rendezvou->sexed}}</td>

                                    <td>{{ $rendezvou->dater}}</td>
                                    <td>{{ $rendezvou->heured}}</td>
                                    <td>
                                    <a class="fa fa-edit" title="Modifier" href="{{ route('ModifrendM.edit',$rendezvou->id) }}"></a>
                                    <a class="fa fa-eye" href="{{ route('RendezvousM.details',$rendezvou->id) }}"  style="color:gray"></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
