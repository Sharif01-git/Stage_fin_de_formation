        ...
        <div class="container">
            ...
            <div class="card">
                ...
                <div class="card-body position-relative p-0 rounded-card-top">
                    <!--begin::Pricing title-->
                    <h3 class="bg-primary text-white text-center py-10 py-lg-20 m-0 rounded-card-top">Tableau de bord</h3>
                    <!--end::Pricing title-->
                            ...
                            <div class="row">
                                ...
                                <div class="offset-lg-3 col-12 col-lg-3 bg-white p-0">
                                    <div class="py-15 px-0 px-lg-5 text-center">
                                        ...
                                        <h4 class="font-size-h3 mb-10 text-dark">Consultation</h4>
                                ...
                                <div class="col-12 col-lg-3 bg-white border-x-0 border-x-lg border-y border-y-lg-0 p-0">
                                    <div class="py-15 px-0 px-lg-5 text-center">
                                        ...
                                        <h4 class="font-size-h3 mb-10 text-dark">Traitement</h4>
                                        <div class="d-flex flex-column pb-7 text-dark-50">
                                ...
                                <div class="col-12 col-lg-3 bg-white mb-10 mb-lg-0 p-0">
                                    <div class="py-15 px-0 px-lg-5 text-center">
                                        ...
                                        <h4 class="font-size-h3 mb-10 text-dark">Ordonnance</h4>
                                        <div class="d-flex flex-column pb-7 text-dark-50">
                                            <span>Le nombre total d'ordonnance</span>
                                            <span>s'élève à : </span>
                                        </div>
                                        <span class="font-size-h1 font-weight-boldest text-dark">8
                                        <sup class="font-size-h3 font-weight-normal pl-1"></sup></span>
                                        <!--begin::Mobile Pricing Table-->
                    ...
                    <div class="row justify-content-center mx-0 mb-15 d-none d-lg-flex">
                        <div class="col-11">
                            ...
                            <div class="row bg-white py-5 font-weight-bold text-center">
                                <div class="col-3 text-left px-5">Up to 10k</div>
                                <div class="col-3 text-left px-5">1</div>
                                <div class="col-3 text-left px-5">20</div>
                                <div class="col-3 text-left px-5">10</div>
                            </div>
                            <!-- end: Bottom Table-->
                        </div>
                    </div>
