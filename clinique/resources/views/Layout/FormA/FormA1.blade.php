                            ...
                            <div class="card-body p-0">
                                <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                                    <div class="col-xl-12 col-xxl-10">
                                        <!--begin::Wizard Form-->
                                        <form method="POST" action="/inscription" class="form" novalidate="novalidate" id="kt_login_signup_form">
                                            @csrf
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-9">
                                                    <input class="form-control " name="prenom" type="text" value="" autofocus/>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-9">
                                                    <div class="input-group ">
                                                        ...
                                                        <input type="text" class="form-control " name="telephone" value="" placeholder="Phone" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-9">
                                                    <input class="form-control " name="adresse" type="text" value="" />
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-xl-3 col-lg-3 col-form-label">Confirmer mot de passe</label>
                                                <div class="col-lg-9 col-xl-9">
