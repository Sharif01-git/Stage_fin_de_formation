    ...
    <div class="subheader py-2 py-lg-4 subheader-transparent" id="kt_subheader">
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Nouveau utilisateur</h5>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <div class="d-flex align-items-center" id="kt_subheader_search">
                    <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">Entrer les détails de l'utilisateur</span>
                </div>
                <!--end::Search Form-->
            </div>
            <!--end::Details-->
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="btn-group ml-2">
                    <button type="button" class="btn btn-primary font-weight-bold btn-sm px-3 font-size-base">Enrégistrer</button>
                        ...
                        <ul class="navi py-5">
                            <li class="navi-item">
                                <a href="#" class="navi-link">
                                    ...
                                    <span class="navi-text">Enrégistrer &amp; continuer</span>
                                </a>
                            </li>
                            <li class="navi-item">
                                <a href="#" class="navi-link">
                                    ...
                                    <span class="navi-text">Enrégistrer &amp; ajouter nouveau</span>
                                </a>
                            </li>
                            <li class="navi-item">
                                <a href="#" class="navi-link">
                                    ...
                                    <span class="navi-text">Enrégistrer &amp; quitter</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                            ...
                            <div class="wizard-steps">
                                <div class="wizard-step" data-wizard-type="step" data-wizard-state="current">
                                    <div class="wizard-wrapper">
                                        ...
                                        <div class="wizard-label">
                                            ...
                                            <div class="wizard-desc">Information personnel</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="wizard-step" data-wizard-type="step">
                                    <div class="wizard-wrapper">
                                        ...
                                        <div class="wizard-label">
                                            <div class="wizard-title">Compte</div>
                                            <div class="wizard-desc">Paramètres de compte </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="wizard-step" data-wizard-type="step">
                                    <div class="wizard-wrapper">
                                        ...
                                        <div class="wizard-label">
                                            <div class="wizard-title">Addresse</div>
                                            <div class="wizard-desc">Adresse de l'utilisateur</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="wizard-step" data-wizard-type="step">
                                    <div class="wizard-wrapper">
                                        ...
                                        <div class="wizard-label">
                                            <div class="wizard-title">Soumettre</div>
                                            <div class="wizard-desc">Revoir les informations</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-xl-9">
                                                    ...
                                                    <div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
                                                        <h5 class="text-dark font-weight-bold mb-10">Détails du profil de l'utilisateur</h5>
                                                        <!--begin::Group-->
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                ...
                                                                <span class="form-text text-muted">Le profil de l'utilisateur au sein de la clinique</span>
                                                            </div>
                                                        </div>
                                                        <!--end::Group-->
                                                        <!--begin::Group-->
                                                    ...
                                                    <div class="my-5 step" data-wizard-type="step-content">
                                                        <h5 class="text-dark font-weight-bold mb-10 mt-5">Détail du compte utilisateur</h5>
                                                        <!--begin::Group-->
                                                        <div class="form-group row">

                                                                <label class="col-lg-2 col-form-label text-right">Login</label>
                                                                <div class="col-lg-4">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <label class="col-lg-2 col-form-label text-right">Mot de passe</label>
                                                            <div class="col-lg-4">
                                                                <input type="email" class="form-control" placeholder="" />
                                                                <span class="form-text text-muted"></span>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <label class="col-lg-2 col-form-label text-right">Confirmer mot de passe</label>
                                                        <div class="col-lg-4">
                                                            <input type="email" class="form-control" placeholder="" />
                                                            <span class="form-text text-muted"></span>
                                                    ...
                                                    <!--begin::Wizard Step 3-->
                                                    <div class="my-5 step" data-wizard-type="step-content">
                                                        <h5 class="mb-10 font-weight-bold text-dark">Adresse</h5>
                                                        <!--begin::Group-->
                                                        <div class="form-group">
                                                            <label>Address 1</label>
                                                            <input type="text" class="form-control form-control-solid form-control-lg" name="address1" placeholder="" value="" />
                                                            <span class="form-text text-muted"></span>
                                                        </div>
                                                        <!--end::Group-->
                                                        <!--begin::Group-->
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid form-control-lg" name="address2" placeholder="" value="" />
                                                            <span class="form-text text-muted"></span>
                                                        </div>
                                                        <!--begin::Row-->
                                                        <div class="row">
                                                            <div class="col-xl-6">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control form-control-solid form-control-lg" name="postcode" placeholder="" value="" />
                                                                    <span class="form-text text-muted"></span>
                                                                </div>
                                                            </div>
                                                            <!--end::Group-->
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-6">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control form-control-solid form-control-lg" name="state" placeholder="" value="" />
                                                                    <span class="form-text text-muted"></span>
                                                                </div>
                                                                <!--end::Group-->
                                                            </div>
                                                    ...
                                                    <!--begin::Wizard Step 4-->
                                                    <div class="my-5 step" data-wizard-type="step-content">
                                                        <h5 class="mb-10 font-weight-bold text-dark">Revoir les détails avan soumission</h5>
                                                        <!--begin::Item-->
                                                        <div class="border-bottom mb-5 pb-5">
                                                            <div class="font-weight-bolder mb-3">Détail de compte:</div>
                                                        ...
                                                        <!--begin::Item-->
                                                        <div class="border-bottom mb-5 pb-5">
                                                            <div class="font-weight-bolder mb-3">Détail adresse</div>
                                                        ...
                                                        <!--begin::Item-->
                                                        <div>
                                                            <div class="font-weight-bolder">Détails</div>
...
<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
    ...
    <div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
        <h3 class="font-weight-bold m-0">Profil de l'utilisateur
