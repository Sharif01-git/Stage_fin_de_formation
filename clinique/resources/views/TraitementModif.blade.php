        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    ...
                    <!--begin::Form-->
                    <form class="form" action="{{route('Traitement.update', $traitement->id)}}" method="POST">
                        @csrf
                        <div class="card-body" align="center">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" name="libelletrait" value="{{$traitement->libelletrait}}"  placeholder="" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" name="nomp" value="{{$traitement->nomp}}" placeholder="" readonly />
                                    <span class="form-text text-muted"></span>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" name="prenomp" value="{{$traitement->prenomp}}" placeholder="" readonly />
                                    <span class="form-text text-muted"></span>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="date" class="form-control" name="date_trait" value="{{$traitement->date_trait}}" placeholder="" />
                                    <span class="form-text text-muted"></span>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" placeholder="" name="auteur" value="{{$traitement->auteur}}" readonly />
                                    <span class="form-text text-muted"></span>
                                </div>
                            </div>
                        ...
                        <input type="hidden" class="form-control" name="patient_id" placeholder="" value="{{$traitement->patient_id}}"/>
                    </form>
                    <!--end::Form-->
                </div>
                <!--end::Card-->
