...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>Page d'accueil du caissier</title>
								...
								<div class="topbar">
									...
									<div class="topbar-item">
										<div class="btn btn-icon btn-hover-transparent-white w-auto d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                                            ...
                                            <a class="dropdown-item " href="/connexionC"><i class="fa fa-power-off m-r-5 m-l-5"></i> </a>
										</div>
                                        <div>
                                            <a href="{{url('/Caissier')}}">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    ...
                    <form class="form" action="{{ route('caisse.update',$facture->id)}}" method="POST">
                        ...
                        <div class="card-body" align="center">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label text-right">Prix du bon de sonsultaion</label>
                                <div class="col-lg-9">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <select class="form-control" name="statu" value="{{$facture->statu}}">
                                        <option value="{{$facture->statu}}">Choisir</option>
